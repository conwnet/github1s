...
if (typeof (window as any)?.vscodeWeb?.product === 'object') {
  Object.assign(product, (window as any)?.vscodeWeb?.product);
} else if (typeof (window as any)?.vscodeWeb?.product === 'function') {
  product = (window as any)?.vscodeWeb?.product(product);
}
