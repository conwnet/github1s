...
import { GettingStartedIndexList } from 'vs/workbench/contrib/welcome/gettingStarted/browser/gettingStartedList';
...
import { GitHub1sWelcomePage } from 'vs/github1s/welcomePage';
// above codes are changed by github1s
...
export class GettingStartedPage extends EditorPane {
	...
	// below codes are changed by github1s
	private gitHub1sWelcomePage!: GitHub1sWelcomePage;
	// above codes are changed by github1s
	...
	constructor(
		...
		// below codes are changed by github1s
		this.gitHub1sWelcomePage = instantiationService.createInstance(GitHub1sWelcomePage);
		// above codes are changed by github1s
	...
	private async buildCategoriesSlide() {
		reset(this.container, this.gitHub1sWelcomePage.render());
	}

	public async buildCategoriesSlide2() {
		// above codes are changed by github1s
