		...
		<ul class="authentication-features">
			<li class="feature-item">
				<a
					...
					target="_blank"
					>Access GitHub Enterprise personal repository</a
				>
			</li>
			<li class="feature-item">
				<a
					...
					target="_blank"
					>Higher rate rimit for GitHub Enterprise official API</a
				>
			</li>
			<li class="feature-item">
				<a
					...
					target="_blank"
					>Support for GitHub Enterprise GraphQL API</a
				>
			</li>
		</ul>
	`;
...
const ManualInputToken = () => {
	const createTokenLink = `${ConfigsForEnterprise.github_enterprise_baseUrl}/settings/tokens/new?scopes=repo&description=GitHubEnterprise1s`;
...
const AuthenticationForm = (props) => {
	return html`
		<div class="authentication-form">
			<div class="form-title">${props.title || 'Authenticating to GitHub Enterprise'}</div>
			<${AuthenticationFeatures} />
			<div class="form-content">
				<${AuthenticationButton}>Connect to GitHub Enterprise<//>
				<${SplitLine} />
				<${ManualInputToken} />
			</div>
		</div>
...
const AuthenticationDetail = ({ accessToken }) => {
	...
	const handleClearToken = useCallback(() => {
		postMessage('call-vscode-message-api', {
			level: 'warning',
			args: ['Would you want to clear the saved GitHub Enterprise AccessToken?', { modal: true }, 'Confirm'],
		...
		<div class="authentication-detail">
			...
			<div class="token-status">
				...
				<ul class="rate-limit-info">
					...
					<li>
						<a href=${ratteLimitDocumentationLink} target="_blank">GitHub Enterprise Rate limiting Documentation</a>
					</li>
				</ul>
			</div>
