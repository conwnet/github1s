...
export class BranchTagManager {
	...
	getBranchList = reuseable(
		async (forceUpdate: boolean = false): Promise<Branch[]> => {
	...
	getBranchItem = reuseable(
		async (branchName: string, forceUpdate = false): Promise<Branch | null> => {
	...
	getTagList = reuseable(
		async (forceUpdate: boolean = false): Promise<Tag[]> => {
	...
	getTagItem = reuseable(
		async (tagName: string, forceUpdate = false): Promise<Tag | null> => {
