...
Just add `1s` after `github` and before `.com` in any GitHub repository's URL in your browser and press `Enter` in browser address bar for any repository you want to read.
