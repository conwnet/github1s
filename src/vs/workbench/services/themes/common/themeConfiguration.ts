...
export function updateColorThemeConfigurationSchemas(
	...
	const experimentalThemeSpecificSemanticTokenColors: IJSONSchema = {
		properties: {},
	};
	...
	for (let t of themes) {
		...
		themeSpecificSemanticTokenColors.properties![
			themeId
		] = semanticTokenColorSchema;
		experimentalThemeSpecificSemanticTokenColors.properties![themeId] = {
			$ref: tokenStylingSchemaId,
			additionalProperties: false,
		};
	}
...
export class ThemeConfiguration {
	...
	public get experimentalSemanticTokenColorCustomizations():
		| IExperimentalSemanticTokenColorCustomizations
		| undefined {
		return this.configurationService.getValue<IExperimentalSemanticTokenColorCustomizations>(
			ThemeSettings.TOKEN_COLOR_CUSTOMIZATIONS_EXPERIMENTAL
		);
	}
	...
	private async writeConfiguration(
		key: string,
		value: any,
		settingsTarget: ConfigurationTarget | 'auto' | undefined
	): Promise<void> {
